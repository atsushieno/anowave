...
// note on
SIOPM.noteOn= function() { SIOPM.mmlPlayer._noteOn(arguments[0]); SIOPM.playing = true; }

// note off
SIOPM.noteOff= function() { SIOPM.mmlPlayer._noteOff(arguments[0]); SIOPM.playing = false; }
